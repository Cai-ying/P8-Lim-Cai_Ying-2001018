...
public class Level_4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button = (Button) findViewById(R.id.endGame4);

        //navigate to Bye page
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Level_4.this,Bye.class);
                startActivity(intent);
            }
        });

        timerTextView = findViewById(R.id.timertextView);
        btnBgSelector = findViewById(R.id.btnBgSelector4);
    ...
    private void navigateToGameOverPage() {
        Intent intent = new Intent(Level_4.this, gameover.class);
        startActivity(intent);
        finish();
    }
}